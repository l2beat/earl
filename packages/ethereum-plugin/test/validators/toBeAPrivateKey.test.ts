...
describe('toBeAPrivateKey', () => {
  ...
  describe('error messages', () => {
    it('is not a private key', () => {
      expect(() => expect('foo').toBeAPrivateKey()).toThrow('String "foo" is not a private key!')
    })

    it('is a private key', () => {
      expect(() =>
        expect('0x319a66d5912bd7b08efb26c2ea2f0b68d521653e3a49db9864d683997be9ed4d').not.toBeAPrivateKey(),
      ).toThrow('String "0x319a66d5912bd7b08efb26c2ea2f0b68d521653e3a49db9864d683997be9ed4d" is a private key!')
    })
  })
})
