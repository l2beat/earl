...
describe('number validators', () => {
  describe('toBeGreaterThan', () => {
    describe('normal', () => {
      ...
      it('fails for an equal number', () => {
        expect(() => earl(3).toBeGreaterThan(3)).to.throw(
          '3 is not greater than 3',
        )
      })

      it('fails for a lesser number', () => {
        expect(() => earl(-2).toBeGreaterThan(4)).to.throw(
    ...
    describe('negated', () => {
      it('fails for a greater number', () => {
        expect(() => earl(2).not.toBeGreaterThan(1)).to.throw(
          '2 is greater than 1',
        )
      })
  ...
  describe('toBeGreaterThanOrEqualTo', () => {
    describe('normal', () => {
      ...
      it('fails for a lesser number', () => {
        expect(() => earl(-2).toBeGreaterThanOrEqualTo(4)).to.throw(
    ...
    describe('negated', () => {
      it('fails for a greater number', () => {
        expect(() => earl(2).not.toBeGreaterThanOrEqualTo(1)).to.throw(
          '2 is greater than or equal to 1',
        )
      })

      it('fails for an equal number', () => {
        expect(() => earl(3).not.toBeGreaterThanOrEqualTo(3)).to.throw(
  ...
  describe('toBeLessThanOrEqualTo', () => {
    describe('normal', () => {
      it('fails for a greater number', () => {
        expect(() => earl(2).toBeLessThanOrEqualTo(1)).to.throw(
    ...
    describe('negated', () => {
      ...
      it('fails for an equal number', () => {
        expect(() => earl(3).not.toBeLessThanOrEqualTo(3)).to.throw(
          '3 is less than or equal to 3',
        )
      })

      it('fails for a lesser number', () => {
        expect(() => earl(-2).not.toBeLessThanOrEqualTo(4)).to.throw(
